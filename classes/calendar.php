...
class Calendar {   
    ...
    * @return              string
    */
	public function show($month=null,$year=null,$attributes=false){ // If it isn't passed any argument, today will be considered
		...
		$content='<div id="calendar">'.
						...
						'<div class="box-content">'.
                            '<div class="guide">'.
                                '<div class="gbox"><div id="holbox">Holiday</div></div>'.
                                '<div class="gbox"><div id="selbox">Selected</div></div>'.
                                '<div class="gbox"><div id="nselbox">Not Selected</div></div>'.
                            '</div>'.
